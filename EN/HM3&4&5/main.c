...
{ 
    ...
    for(MAIN__u32StrMinIdx = 0; MAIN__u32StrMinIdx < MAIN__nOutputs; ++MAIN__u32StrMinIdx) {
        ...
        */
        ...
        for(; MAIN__au16Octets[MAIN__u32StrMinIdx][MAIN__u32Idx] != 0; ++MAIN__u32Idx) {
        ...
        /* Min matrix filled */
        for(uint32_t u32J = 0; u32J < MAIN__u32MaxMinIdx; ++u32J) {
...
MAIN__vFindAdjacents(void) {
    ...
    for(u32Idx = 0; MAIN__au16Octets[MAIN__u32StrMinIdx][u32Idx] != 0; ++u32Idx) {
        
        for(u32Jdx = u32Idx + 1; MAIN__au16Octets[MAIN__u32StrMinIdx][u32Jdx] != 0; ++u32Jdx) {
